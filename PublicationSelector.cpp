...
namespace sdds {
    // Function to display the publications on a specified page
    ...
    // Function to get the selected library reference from the user
    ...
    // Destructor for PublicationSelector
    PublicationSelector::~PublicationSelector() {
        delete[] m_pub;
    }

    // Constructor for PublicationSelector
    ...
    // Overloaded insertion operator to add a Publication to the selector
    PublicationSelector& PublicationSelector::operator<<(const Publication& pub) {
        return operator<<(&pub);
    }

    // Overloaded insertion operator to add a Publication pointer to the selector
    PublicationSelector& PublicationSelector::operator<<(const Publication* pub) {
    ...
    // Function to run the publication selector
    ...
    // Function to sort the publications by checkout date and title
    ...
    // Conversion operator to bool for PublicationSelector
